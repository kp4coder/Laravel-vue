            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Taxes</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" onclick="deleteData('{{ $row->id }}', 'taxes' )" class="btn delete_{{ $row->id }}">
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="{{ url('admin/updateTax') }}" id="formSubmit" method="POST" enctype="multipart/form-data">
                @csrf
