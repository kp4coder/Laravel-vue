                    ...
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" onclick="saveData('{{ $row->id }}', '{{ $row->text }}', '{{ $row->link }}', '{{ $row->image }}')" class="btn" data-bs-toggle="modal" data-bs-target="#addModal">
                                        <i class="fadeIn animated bx bx-edit"></i>
                                    </button>
                                    <button type="button" onclick="deleteData('{{ $row->id }}', 'home_banners' )" class="btn" data-bs-toggle="modal" data-bs-target="#addModal">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div id="showImage"> <img src="" width="100px" height="100px" /></div>
                        </div>
                    </div>
...
<script>
    function saveData(id, text, link, image) {
        ...
        if( image == '' ) {
            ...
            jQuery("#showImage img").attr('src', "{{ URL::asset('images') }}/"+image);
